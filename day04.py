...
# assert valid("abcde xyz ecdab") == 0
# assert valid("a ab abc abd abf abj") == 1
# assert valid("iiii oiii ooii oooi oooo") == 1
# assert valid("oiii ioii iioi iiio") == 0
# part 1
print(valid(PASSPHRASES))


# part 2 ajunwalker sol
total = 0
